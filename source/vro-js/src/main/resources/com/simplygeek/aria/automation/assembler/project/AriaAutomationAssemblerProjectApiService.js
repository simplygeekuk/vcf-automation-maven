...
(function () {
    /**
     * Defines the AriaAutomationAssemblerProjectApiService class.
     * @class
     * @param {REST:RESTHost} restHost - The Aria Automation HTTP REST host.
     * 
     * @returns {Any} An instance of the AriaAutomationAssemblerProjectApiService class.
     */

    function AriaAutomationAssemblerProjectApiService(restHost) {
        AriaAutomationGenericBackendService.call(this, restHost);

        this.log = new (System.getModule("com.simplygeek.log").Logger())(
            "Action",
            "AriaAutomationAssemblerProjectApiService"
        );

        this.baseUri = "/project-service/api";
        this.apiVersion = "2019-01-15";
    ...
    AriaAutomationAssemblerProjectApiService.prototype = Object.create(AriaAutomationGenericBackendService.prototype);
    AriaAutomationAssemblerProjectApiService.prototype.constructor = AriaAutomationAssemblerProjectApiService;
    ...
    AriaAutomationAssemblerProjectApiService.prototype.getProjects = function () {
    ...
    AriaAutomationAssemblerProjectApiService.prototype.getCustomNamingById = function (
        customNamingId,
        throwOnNotFound
    ) {
        ...
        var customNamingObject = this.get(uri, null, throwOnNotFound);
    ...
    AriaAutomationAssemblerProjectApiService.prototype.getCustomNamingByName = function (
        customNamingName,
        throwOnNotFound
    ) {
        ...
        if (results.length > 1) {
            throw new Error(
                "More than one custom naming found. Unable to determine correct job" +
                " template with name '" + customNamingName + "'"
            );
    ...
    AriaAutomationAssemblerProjectApiService.prototype.updateCustomNaming = function (
        customNamingId,
        updatedObject
    ) {
        if (!customNamingId || typeof customNamingId !== "string") {
    ...
    AriaAutomationAssemblerProjectApiService.prototype.checkCustomNamingPrefixExists = function (
        customNamingId,
        prefix
    ) {
        if (!customNamingId || typeof customNamingId !== "string") {
    ...
    AriaAutomationAssemblerProjectApiService.prototype.addCustomNamingPrefixToTemplate = function (
        customNamingId,
        prefix,
        resourceType,
        startCounter,
    ...
    return AriaAutomationAssemblerProjectApiService;
});