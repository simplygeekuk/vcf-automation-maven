...
(function () {
    ...
    AriaAutomationAssemblerIaaSApiService.prototype.getCustomNamingById = function (
        customNamingId,
        throwOnNotFound
    ) {
    ...
    AriaAutomationAssemblerIaaSApiService.prototype.getCustomNamingByName = function (
        customNamingName,
        throwOnNotFound
    ) {
    ...
    AriaAutomationAssemblerIaaSApiService.prototype.updateCustomNaming = function (
        customNamingId,
        updatedObject
    ) {
        if (!customNamingId || typeof customNamingId !== "string") {
    ...
    AriaAutomationAssemblerIaaSApiService.prototype.checkCustomNamingPrefixExists = function (
        customNamingId,
        prefix
    ) {
        if (!customNamingId || typeof customNamingId !== "string") {
    ...
    AriaAutomationAssemblerIaaSApiService.prototype.addCustomNamingPrefixToTemplate = function (
        customNamingId,
        prefix,
        resourceType,
        startCounter,
