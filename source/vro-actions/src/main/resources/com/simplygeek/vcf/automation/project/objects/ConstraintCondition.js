...
(function () {
     ...
     */
    function ConstraintCondition(tag, enforcement, occurrence) {
        // Mandatory parameters, defaults and type checking.
        var validEnforcementTypes = ["HARD", "SOFT"];
        var validOccurrenceTypes = ["MUST_OCCUR", "MUST_NOT_OCCUR"];
        ...
        if (enforcement && typeof enforcement !== "string") {
            ...
            enforcement &&
            validEnforcementTypes.indexOf(enforcement.toUpperCase()) < 0
        ) {
            throw new ReferenceError(
                "Unsupported enforcement type '" +
                    enforcement +
                    "'." +
        ...
        if (occurrence && typeof occurrence !== "string") {
            ...
            occurrence &&
            validOccurrenceTypes.indexOf(occurrence.toUpperCase()) < 0
        ) {
            throw new ReferenceError(
