...
(function (vcHostInstanceUuid) {
    ...
    try {
        log.info(
            "Locating vCenter Server with instance uuid: " + vcHostInstanceUuid
        );
        allVcenterSdks = VcPlugin.allSdkConnections;
        vCenterSdksFiltered = allVcenterSdks.filter(function (vcHost) {
        ...
        throw new Error(
            "Action failed locate a vCenter Server for the specified instance uuid. ",
            e
        );
    }
