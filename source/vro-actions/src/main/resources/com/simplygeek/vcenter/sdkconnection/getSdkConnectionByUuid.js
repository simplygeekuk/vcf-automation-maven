...
(function (sdkConnectionUuid) {
    ...
    if (sdkConnection) {
        ...
        throw new Error(
            "No SdkConnection found with UUID '" + sdkConnectionUuid + "'"
        );
    }
